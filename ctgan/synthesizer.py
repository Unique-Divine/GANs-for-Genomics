...
class CTGANSynthesizer(object):
    ...
    def fit(self, train_data, discrete_columns=tuple(), epochs=300, 
            log_frequency=True, verbose=False):
        ...
        for i in range(epochs):
            ...
            if verbose == True:
                if self.trained_epochs % 10 == 0:
                    print(f"Epoch {self.trained_epoches}, "
